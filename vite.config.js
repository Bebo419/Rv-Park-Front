...
export default defineConfig({
  server: {
    ...
    proxy: {
      '/api': {
        target: 'https://rv-park-backend.onrender.com',
        changeOrigin: true,
        secure: false,
      }
    }
  ...
  plugins: [
    ...
    VitePWA({
      ...
      injectRegister: 'auto',
      includeAssets: ['favicon.ico', 'icons/*.png', '/android', '/ios', '/windows11'],
      manifest: {
        name: 'RV Park Manager',
        short_name: 'RV Parks',
        description: 'Sistema de Gestión de RV Parks - Progressive Web App',
        theme_color: '#3b82f6',
